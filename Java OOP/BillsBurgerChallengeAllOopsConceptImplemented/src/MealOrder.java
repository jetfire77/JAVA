public class MealOrder {
    ...
    private Burger burger;  // composition
    private Item drink;  // composition

    private Item side;  // composition
    ...
    public double getTotalPrice(){
       if(burger instanceof DeluxeBurger)  // if burger is delux burger dont include price of drink and side
       {
